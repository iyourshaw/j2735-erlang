...
'Common':enc_IntersectionReferenceID(Enc10@element)
end,
begin
...
'Common':enc_Position3D(Enc13@element)
end,
begin
...
[];
true ->
'Common':enc_SpeedLimitList(Enc17@element)
end
end,
begin
...
typeinfo('SignalControlZone') ->
  {sequence,'SignalControlZone',1,[{<<122,111,110,101>>,{sequence,'SignalControlZone_zone',2,[{<<114,101,103,105,111,110,73,100>>,{'INTEGER',{0,255}},mandatory},{<<114,101,103,69,120,116,86,97,108,117,101>>,{'ObjClassFieldType',{regionId,1},{componentrelation,{objectset,121,{'Externaltypereference',undefined,'MapData',internal_object_set_argument_3}},[{outermost,[{'Externalvaluereference',121,'Common',regionId}]}]}},mandatory}]},mandatory}]};
