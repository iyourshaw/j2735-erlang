...
[];
true ->
'Common':enc_NodeOffsetPointXY(Enc3@element)
end
end].
...
1 ->
'Common':dec_NodeOffsetPointXY(Bytes2);
0 ->
{asn1_NOVALUE,Bytes2}
end,
...
Enc2@element = element(2, Val),
'Common':enc_NodeOffsetPointXY(Enc2@element)
end|begin
...
%% attribute node(1) with type NodeOffsetPointXY
{Term1,Bytes2} = 'Common':dec_NodeOffsetPointXY(Bytes1),
...
typeinfo('ConnectionManeuverAssist-addGrpC') ->
  {sequence,'ConnectionManeuverAssist-addGrpC',2,[{<<118,101,104,105,99,108,101,84,111,76,97,110,101,80,111,115,105,116,105,111,110,115>>,{typeinfo,{'AddGrpC','VehicleToLanePositionList'}},mandatory},{<<114,115,117,68,105,115,116,97,110,99,101,70,114,111,109,65,110,99,104,111,114>>,{typeinfo,{'Common','NodeOffsetPointXY'}},'OPTIONAL'}]};
...
typeinfo('SignalHeadLocation') ->
  {sequence,'SignalHeadLocation',2,[{<<110,111,100,101>>,{typeinfo,{'Common','NodeOffsetPointXY'}},mandatory},{<<115,105,103,110,97,108,71,114,111,117,112,73,68>>,{'INTEGER',{0,255}},mandatory}]};
