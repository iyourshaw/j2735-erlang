...
%% Purpose: Encoding and decoding of the types in RTCMcorrections.
...
try encode_jer('RTCMcorrections', Type, Data) of
  Bytes ->
    {ok,Bytes}
  catch
    Class:Exception:Stk when Class =:= error; Class =:= exit ->
...
try
   Result = decode_jer('RTCMcorrections', Type, json:decode(Data)),
   {ok,Result}
  catch
    Class:Exception:Stk when Class =:= error; Class =:= exit ->
      case Exception of
...
[];
true ->
'Common':enc_FullPositionVector(Enc13@element)
end
end,
begin
...
[];
true ->
'Common':enc_RTCMheader(Enc15@element)
end
end,
begin
%% attribute msgs(6) with type RTCMmessageList
Enc17@element = element(7, Val),
'Common':enc_RTCMmessageList(Enc17@element)
end|begin
...
1 ->
'Common':dec_FullPositionVector(Bytes5);
0 ->
{asn1_NOVALUE,Bytes5}
end,
...
1 ->
'Common':dec_RTCMheader(Bytes6);
0 ->
{asn1_NOVALUE,Bytes6}
end,

%% attribute msgs(6) with type RTCMmessageList
{Term6,Bytes8} = 'Common':dec_RTCMmessageList(Bytes7),
...
typeinfo('RTCMcorrections') ->
  {sequence,'RTCMcorrections',7,[{<<109,115,103,67,110,116>>,{'INTEGER',{0,127}},mandatory},{<<114,101,118>>,{'ENUMERATED_EXT',#{unknown => 0,reserved => 3,rtcmRev2 => 1,rtcmRev3 => 2}},mandatory},{<<116,105,109,101,83,116,97,109,112>>,{'INTEGER',{0,527040}},'OPTIONAL'},{<<97,110,99,104,111,114,80,111,105,110,116>>,{typeinfo,{'Common','FullPositionVector'}},'OPTIONAL'},{<<114,116,99,109,72,101,97,100,101,114>>,{typeinfo,{'Common','RTCMheader'}},'OPTIONAL'},{<<109,115,103,115>>,{typeinfo,{'Common','RTCMmessageList'}},mandatory},{<<114,101,103,105,111,110,97,108>>,{sof,{sequence,'RTCMcorrections_regional_SEQOF',2,[{<<114,101,103,105,111,110,73,100>>,{'INTEGER',{0,255}},mandatory},{<<114,101,103,69,120,116,86,97,108,117,101>>,{'ObjClassFieldType',{regionId,1},{componentrelation,{objectset,121,{'Externaltypereference',undefined,'RTCMcorrections',internal_object_set_argument_1}},[{outermost,[{'Externalvaluereference',121,'Common',regionId}]}]}},mandatory}]}},'OPTIONAL'}]};
