...
begin
%% attribute notUsed1(8) with type INTEGER
...
begin
%% attribute notUsed2(10) with type INTEGER
...
begin
%% attribute notUsed3(11) with type INTEGER
...
typeinfo('TravelerDataFrame') ->
  {sequence,'TravelerDataFrame',13,[{<<110,111,116,85,115,101,100>>,{'INTEGER',{0,31}},mandatory},{<<102,114,97,109,101,84,121,112,101>>,{'ENUMERATED_EXT',#{unknown => 0,advisory => 1,roadSignage => 2,commercialSignage => 3}},mandatory},{<<109,115,103,73,100>>,{choice,#{<<102,117,114,116,104,101,114,73,110,102,111,73,68>> => octet_string,<<114,111,97,100,83,105,103,110,73,68>> => {typeinfo,{'TravelerInformation','RoadSignID'}}}},mandatory},{<<115,116,97,114,116,89,101,97,114>>,{'INTEGER',{0,4095}},'OPTIONAL'},{<<115,116,97,114,116,84,105,109,101>>,{'INTEGER',{0,527040}},mandatory},{<<100,117,114,97,116,105,111,110,84,105,109,101>>,{'INTEGER',{0,32000}},mandatory},{<<112,114,105,111,114,105,116,121>>,{'INTEGER',{0,7}},mandatory},{<<110,111,116,85,115,101,100,49>>,{'INTEGER',{0,31}},mandatory},{<<114,101,103,105,111,110,115>>,{sof,{typeinfo,{'TravelerInformation','GeographicalPath'}}},mandatory},{<<110,111,116,85,115,101,100,50>>,{'INTEGER',{0,31}},mandatory},{<<110,111,116,85,115,101,100,51>>,{'INTEGER',{0,31}},mandatory},{<<99,111,110,116,101,110,116>>,{choice,#{<<97,100,118,105,115,111,114,121>> => {typeinfo,{'ITIS','ITIScodesAndText'}},<<101,120,105,116,83,101,114,118,105,99,101>> => {typeinfo,{'TravelerInformation','ExitService'}},<<103,101,110,101,114,105,99,83,105,103,110>> => {typeinfo,{'TravelerInformation','GenericSignage'}},<<115,112,101,101,100,76,105,109,105,116>> => {typeinfo,{'TravelerInformation','SpeedLimit'}},<<119,111,114,107,90,111,110,101>> => {typeinfo,{'TravelerInformation','WorkZone'}}}},mandatory},{<<117,114,108>>,string,'OPTIONAL'}]};
