...
typeinfo('DetectedVRUData') ->
  {sequence,'DetectedVRUData',4,[{<<98,97,115,105,99,84,121,112,101>>,{'ENUMERATED_EXT',#{unavailable => 0,aPEDESTRIAN => 1,aPEDALCYCLIST => 2,aPUBLICSAFETYWORKER => 3,anANIMAL => 4}},'OPTIONAL'},{<<112,114,111,112,117,108,115,105,111,110>>,{typeinfo,{'PersonalSafetyMessage','PropelledInformation'}},'OPTIONAL'},{<<97,116,116,97,99,104,109,101,110,116>>,{'ENUMERATED_EXT',#{unavailable => 0,pet => 6,stroller => 1,bicycleTrailer => 2,cart => 3,wheelchair => 4,otherWalkAssistAttachments => 5}},'OPTIONAL'},{<<114,97,100,105,117,115>>,{'INTEGER',{0,200}},'OPTIONAL'}]};
