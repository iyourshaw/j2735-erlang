...
Enc7@bitmap = extension_bitmap(Val, 12, 13),
...
if 0 =< Enc10@len@sub, Enc10@len@sub < 63 ->
[<<Enc10@len@sub:6>>|Enc10@bin]
end
end
end
end,
...
'Common':enc_IntersectionReferenceID(Enc12@element)
end,
begin
...
Enc15@element = element(5, Val),
Enc16@bs = try bit_string_name2pos_10(Enc15@element) of
Enc16@positions ->
bitstring_from_positions(Enc16@positions, 16)
catch throw:invalid ->
adjust_trailing_zeroes(Enc15@element, 16)
end,
...
[];
0 =< Enc17@element, Enc17@element < 527041 ->
<<Enc17@element:20>>;
true ->
...
[];
true ->
enc_ManeuverAssistList(Enc26@element)
end
end,
begin
...
[];
true ->
enc_IntersectionState_regional(Enc28@element)
end
end,
Extensions|begin
%% attribute roadAuthorityID(11) with type RoadAuthorityID
Enc30@element = element(12, Val),
if Enc30@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc31@output = 'Common':enc_RoadAuthorityID(Enc30@element),
...
{TmpValx11,_} = 'Common':dec_RoadAuthorityID(V9@V0),
{TmpValx11,V9@Buf1}
end;
_  ->
{asn1_NOVALUE,Bytes13}
end,
Bytes15= skipextensions(Bytes14, 2, Extensions),
Res1 = {'IntersectionState',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8,Term9,Term10,Term11},
{Res1,Bytes15}.
