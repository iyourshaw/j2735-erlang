...
%% Purpose: Encoding and decoding of the types in PersonalSafetyMessage2.
...
-export([typeinfo/1]).
-export([
enc_PersonalSafetyMessage2/1
]).

-export([
dec_PersonalSafetyMessage2/1
]).
...
try encode_jer('PersonalSafetyMessage2', Type, Data) of
  Bytes ->
    {ok,Bytes}
  catch
    Class:Exception:Stk when Class =:= error; Class =:= exit ->
...
try
   Result = decode_jer('PersonalSafetyMessage2', Type, json:decode(Data)),
   {ok,Result}
  catch
    Class:Exception:Stk when Class =:= error; Class =:= exit ->
      case Exception of
...
encode_disp('PersonalSafetyMessage2', Data) -> enc_PersonalSafetyMessage2(Data);
encode_disp(Type, _Data) -> exit({error,{asn1,{undefined_type,Type}}}).

decode_disp('PersonalSafetyMessage2', Data) -> dec_PersonalSafetyMessage2(Data);
...
enc_PersonalSafetyMessage2(Val) ->
[].


dec_PersonalSafetyMessage2(Bytes) ->
begin
ignore,
{'NULL',Bytes}
end.

typeinfo('PersonalSafetyMessage2') ->
  'NULL';
typeinfo(Type) ->
