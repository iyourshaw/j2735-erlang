...
typeinfo('Attachment') ->
  {'ENUMERATED_EXT',#{unavailable => 0,wheelchair => 4,pet => 6,stroller => 1,bicycleTrailer => 2,cart => 3,otherWalkAssistAttachments => 5}};
...
typeinfo('HumanPropelledType') ->
  {'ENUMERATED_EXT',#{unavailable => 0,otherTypes => 1,onFoot => 2,skateboard => 3,pushOrKickScooter => 4,wheelchair => 5}};
