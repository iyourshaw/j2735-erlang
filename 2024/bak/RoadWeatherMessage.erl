...
typeinfo('NtcipPavement') ->
  {sequence,'NtcipPavement',5,[{<<115,117,114,102,97,99,101,84,101,109,112>>,{'INTEGER',{-1000,1001}},'OPTIONAL'},{<<116,101,109,112,83,116,100,68,101,118>>,{'INTEGER',{1,16}},'OPTIONAL'},{<<99,111,110,100,105,116,105,111,110>>,{'ENUMERATED_EXT',#{error => 2,other => 1,dry => 3,wet => 6,ice => 12,snow => 11,frost => 9,slush => 10,moist => 4,chemicallyMoist => 5,chemicallyWet => 7,standingWater => 8,noReport => 13}},'OPTIONAL'},{<<109,111,105,115,116,117,114,101,68,101,112,116,104>>,{'INTEGER',{0,65535}},'OPTIONAL'},{<<114,111,97,100,82,111,117,103,104,110,101,115,115>>,{typeinfo,{'Common','RoadRoughness'}},'OPTIONAL'}]};
typeinfo('NTCIPEssSurfaceTemperature') ->
  {'INTEGER',{-1000,1001}};
typeinfo('NTCIPPavementSensorSurfaceCondition') ->
  {'ENUMERATED_EXT',#{error => 2,other => 1,dry => 3,wet => 6,ice => 12,snow => 11,frost => 9,slush => 10,moist => 4,chemicallyMoist => 5,chemicallyWet => 7,standingWater => 8,noReport => 13}};
