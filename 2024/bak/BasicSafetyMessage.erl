...
%% attribute doNotUse(3) with type TrailerData
Enc9@element = element(4, Val),
if Enc9@element =:= asn1_NOVALUE ->
[];
true ->
...
[];
true ->
'Common':enc_VehicleClassification(Enc16@element)
end
end,
begin
...
[];
true ->
enc_VehicleData(Enc18@element)
end
end,
begin
%% attribute doNotUse1(4) with type WeatherReport
Enc20@element = element(5, Val),
if Enc20@element =:= asn1_NOVALUE ->
[];
true ->
enc_WeatherReport(Enc20@element)
end
end,
begin
%% attribute doNotUse2(5) with type WeatherProbe
Enc22@element = element(6, Val),
if Enc22@element =:= asn1_NOVALUE ->
[];
true ->
enc_WeatherProbe(Enc22@element)
end
end,
begin
%% attribute doNotUse3(6) with type ObstacleDetection
Enc24@element = element(7, Val),
if Enc24@element =:= asn1_NOVALUE ->
[];
true ->
enc_ObstacleDetection(Enc24@element)
end
end,
begin
...
[];
true ->
enc_DisabledVehicle(Enc26@element)
end
end,
begin
%% attribute doNotUse4(8) with type SpeedProfile
Enc28@element = element(9, Val),
if Enc28@element =:= asn1_NOVALUE ->
[];
true ->
enc_SpeedProfile(Enc28@element)
end
end,
begin
%% attribute doNotUse5(9) with type RTCMPackage
Enc30@element = element(10, Val),
if Enc30@element =:= asn1_NOVALUE ->
[];
true ->
enc_RTCMPackage(Enc30@element)
end
end,
begin
...
[];
true ->
enc_SupplementalVehicleExtensions_regional(Enc32@element)
end
end,
Extensions,
begin
%% attribute fhwaVehicleClass(11) with type ENUMERATED
Enc34@element = element(12, Val),
if Enc34@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc36@output = if Enc34@element =:= motorcycles ->
<<0:1,0:4>>;
Enc34@element =:= passengerCars ->
<<0:1,1:4>>;
Enc34@element =:= other2axle4tireSingleUnitVehs ->
<<0:1,2:4>>;
Enc34@element =:= buses ->
<<0:1,3:4>>;
Enc34@element =:= twoAxle6TireSingleUnitTrucks ->
<<0:1,4:4>>;
Enc34@element =:= threeAxleSingleUnitTrucks ->
<<0:1,5:4>>;
Enc34@element =:= fourOrMoreAxleSingleUnitTrucks ->
<<0:1,6:4>>;
Enc34@element =:= fourOrFewerAxleSingleTrailerTrucks ->
<<0:1,7:4>>;
Enc34@element =:= fiveAxleSingleTrailerTrucks ->
<<0:1,8:4>>;
Enc34@element =:= sixOrMoreAxleSingleTrailerTrucks ->
<<0:1,9:4>>;
Enc34@element =:= fiveOrFewerAxleMultiTrailerTrucks ->
<<0:1,10:4>>;
Enc34@element =:= sixAxleMultiTrailerTrucks ->
<<0:1,11:4>>;
Enc34@element =:= sevenOrMoreAxleMultiTrailerTrucks ->
<<0:1,12:4>>;
true ->
...
begin
%% attribute trailers(12) with type TrailersJ2945Slash1B
Enc38@element = element(13, Val),
if Enc38@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc39@output = 'Common':enc_TrailersJ2945Slash1B(Enc38@element),
...
true ->
encode_fragmented(Enc39@bin, 8)
end
end
end
end|begin
%% attribute schoolBus(13) with type SchoolBusJ2945Slash1C
Enc41@element = element(14, Val),
if Enc41@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc42@output = 'Common':enc_SchoolBusJ2945Slash1C(Enc41@element),
...
{TmpValx12,_} = 'Common':dec_TrailersJ2945Slash1B(V7@V0),
{TmpValx12,V7@Buf1}
end;
_  ->
...
<<0:1,V8@V3:7,V8@V5:V8@V3/binary-unit:8,V8@Buf6/bitstring>> ->
{V8@V5,V8@Buf6};
<<1:1,0:1,V8@V4:14,V8@V6:V8@V4/binary-unit:8,V8@Buf7/bitstring>> ->
{V8@V6,V8@Buf7};
<<1:1,1:1,V8@V4:6,V8@Buf5/bitstring>> ->
{V8@V6,V8@Buf7}  = decode_fragmented(V8@V4, V8@Buf5, 8),
{V8@V6,V8@Buf7}
end,
{TmpValx13,_} = 'Common':dec_SchoolBusJ2945Slash1C(V8@V0),
{TmpValx13,V8@Buf1}
end;
_  ->
...
Res1 = {'SupplementalVehicleExtensions',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8,Term9,Term10,Term11,Term12,Term13},
{Res1,Bytes17}.
...
enc_VehicleData(Val) ->
Enc5@bitmap = extension_bitmap(Val, 6, 10),
...
[];
true ->
'Common':enc_BumperHeights(Enc10@element)
end
end,
begin
...
begin
%% attribute doNotUse(4) with type INTEGER
Enc15@element = element(5, Val),
if Enc15@element =:= asn1_NOVALUE ->
[];
0 =< Enc15@element, Enc15@element < 64256 ->
<<Enc15@element:16>>;
true ->
...
Extensions,
begin
%% attribute trailerPresent(5) with type BOOLEAN
...
begin
%% attribute pivotPoint(6) with type PivotPointDescription
Enc22@element = element(7, Val),
if Enc22@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc23@output = enc_PivotPointDescription(Enc22@element),
...
true ->
encode_fragmented(Enc23@bin, 8)
end
end
end
end,
begin
%% attribute axles(7) with type Axles
Enc25@element = element(8, Val),
if Enc25@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc26@output = 'Common':enc_Axles(Enc25@element),
...
%% attribute leanAngle(8) with type INTEGER
Enc28@element = element(9, Val),
if Enc28@element =:= asn1_NOVALUE ->
[];
true ->
begin
Enc30@output = begin
Enc28@element@sub = Enc28@element - -90,
if 0 =< Enc28@element@sub, Enc28@element@sub < 181 ->
[Enc28@element@sub];
true ->
exit({error,{asn1,{illegal_integer,Enc28@element}}})
end
end,
Enc30@bin = iolist_to_binary(Enc30@output),
[1|Enc30@bin]
end
end
end].
...
<<0:1,V9@V3:7,V9@V5:V9@V3/binary-unit:8,V9@Buf6/bitstring>> ->
{V9@V5,V9@Buf6};
<<1:1,0:1,V9@V4:14,V9@V6:V9@V4/binary-unit:8,V9@Buf7/bitstring>> ->
{V9@V6,V9@Buf7};
<<1:1,1:1,V9@V4:6,V9@Buf5/bitstring>> ->
{V9@V6,V9@Buf7}  = decode_fragmented(V9@V4, V9@Buf5, 8),
{V9@V6,V9@Buf7}
end,
{TmpValx6,_} = dec_PivotPointDescription(V9@V0),
{TmpValx6,V9@Buf1}
end;
_  ->
{asn1_NOVALUE,Bytes8}
...
{TmpValx7,_} = 'Common':dec_Axles(V10@V0),
{TmpValx7,V10@Buf1}
end;
_  ->
{asn1_NOVALUE,Bytes9}
...
<<0:1,V11@V3:7,V11@V5:V11@V3/binary-unit:8,V11@Buf6/bitstring>> ->
{V11@V5,V11@Buf6};
<<1:1,0:1,V11@V4:14,V11@V6:V11@V4/binary-unit:8,V11@Buf7/bitstring>> ->
{V11@V6,V11@Buf7};
<<1:1,1:1,V11@V4:6,V11@Buf5/bitstring>> ->
{V11@V6,V11@Buf7}  = decode_fragmented(V11@V4, V11@Buf5, 8),
{V11@V6,V11@Buf7}
end,
{TmpValx8,_} = begin
<<V12@V0:8,V12@Buf1/bitstring>> = V11@V0,
V12@Add2 = V12@V0 + -90,
{V12@Add2,V12@Buf1}
end,
{TmpValx8,V11@Buf1}
...
Bytes12= skipextensions(Bytes11, 5, Extensions),
Res1 = {'VehicleData',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8},
{Res1,Bytes12}.
...
typeinfo('BasicSafetyMessage') ->
  {sequence,'BasicSafetyMessage',3,[{<<99,111,114,101,68,97,116,97>>,{typeinfo,{'Common','BSMcoreData'}},mandatory},{<<112,97,114,116,73,73>>,{sof,{sequence,'BasicSafetyMessage_partII_SEQOF',2,[{<<112,97,114,116,73,73,45,73,100>>,{'INTEGER',{0,63}},mandatory},{<<112,97,114,116,73,73,45,86,97,108,117,101>>,{'ObjClassFieldType',{'partII-Id',1},{componentrelation,{objectset,182,{'Externaltypereference',undefined,'BasicSafetyMessage',internal_object_set_argument_1}},[{outermost,[{'Externalvaluereference',182,'BasicSafetyMessage','partII-Id'}]}]}},mandatory}]}},'OPTIONAL'},{<<114,101,103,105,111,110,97,108>>,{sof,{sequence,'BasicSafetyMessage_regional_SEQOF',2,[{<<114,101,103,105,111,110,73,100>>,{'INTEGER',{0,255}},mandatory},{<<114,101,103,69,120,116,86,97,108,117,101>>,{'ObjClassFieldType',{regionId,1},{componentrelation,{objectset,134,{'Externaltypereference',undefined,'BasicSafetyMessage',internal_object_set_argument_2}},[{outermost,[{'Externalvaluereference',134,'Common',regionId}]}]}},mandatory}]}},'OPTIONAL'}]};
typeinfo('PartII-Id') ->
  {'INTEGER',{0,63}};
typeinfo('DisabledVehicle') ->
  {sequence,'DisabledVehicle',2,[{<<115,116,97,116,117,115,68,101,116,97,105,108,115>>,{'INTEGER',{0,65535}},mandatory},{<<108,111,99,97,116,105,111,110,68,101,116,97,105,108,115>>,{'ENUMERATED_EXT',#{'picnic-areas' => 7985,'information-welcome-point' => 7981,platform => 7977,'other-than-on-the-roadway' => 7966,depot => 7979,'in-the-opposite-direction' => 7992,'on-bend' => 7946,'near-the-foothills' => 7961,gate => 7973,dip => 8010,north => 7998,'on-the-right' => 7989,northwest => 8003,'in-the-valley' => 7959,'near-the-shore' => 7964,'moved-to-side-of-road' => 7949,'nearby-basin' => 8008,south => 7999,shoulder => 8027,'entering-or-leaving-tunnels' => 7939,'area-of' => 8017,'side-road' => 8030,'roadside-park' => 8033,'upper-level' => 7970,to => 8014,dock => 7978,'near-the-lake' => 7963,under => 8018,'cross-traffic' => 7993,'in-parts' => 7956,'on-curve' => 8026,through => 8016,'on-minor-roads' => 7943,'in-some-places' => 7957,'lower-level' => 7969,'in-shaded-areas' => 7952,concourse => 7972,'over-the-crest-of-a-hill' => 7965,'in-the-median' => 7948,'in-the-ditch' => 7958,'cross-road' => 8029,'on-the-roadway' => 7951,'at-weigh-station' => 7984,'baggage-claim' => 7974,east => 8000,'entering-at' => 8022,'in-the-downtown-area' => 7954,'in-the-opposing-lanes' => 7944,'near-beach-access-point' => 7968,station => 7976,'entire-intersection' => 7947,'park-and-ride-lot' => 8012,over => 8019,southeast => 8004,'southbound-traffic' => 7996,airport => 7971,'rest-area' => 7986,'at-service-area' => 7983,southwest => 8005,'adjacent-to-roadway' => 7945,'eastbound-traffic' => 7995,'at-rest-area' => 7982,'across-tracks' => 8024,intersection => 8032,'ev-charging-point' => 7980,'reservation-center' => 8007,'on-tracks' => 8009,'in-road-construction-area' => 7941,west => 8001,'in-street' => 8025,'in-the-inner-city-area' => 7955,toilets => 7988,'service-stations' => 7987,'bus-stop' => 8031,'in-tunnels' => 7938,from => 8020,'in-low-lying-areas' => 7953,'westbound-traffic' => 7997,by => 8015,'mountain-pass' => 8006,'near-the-beach' => 7967,'on-hill-top' => 7960,crossover => 8028,'around-a-curve' => 7942,approaching => 8021,'moved-to-shoulder' => 7950,northeast => 8002,'in-the-center' => 7991,'northbound-traffic' => 7994,'exiting-at' => 8023,'traffic-circle' => 8011,'on-bridges' => 7937,'at-high-altitudes' => 7962,'customs-point' => 7975,'on-the-left' => 7990,'on-ramps' => 7940}},'OPTIONAL'}]};
...
typeinfo('ObstacleDetection') ->
  {sequence,'ObstacleDetection',6,[{<<111,98,68,105,115,116>>,{'INTEGER',{0,32767}},mandatory},{<<111,98,68,105,114,101,99,116>>,{'INTEGER',{0,28800}},mandatory},{<<100,101,115,99,114,105,112,116,105,111,110>>,{'INTEGER',{0,65535}},'OPTIONAL'},{<<108,111,99,97,116,105,111,110,68,101,116,97,105,108,115>>,{'ENUMERATED_EXT',#{'picnic-areas' => 7985,'information-welcome-point' => 7981,platform => 7977,'other-than-on-the-roadway' => 7966,depot => 7979,'in-the-opposite-direction' => 7992,'on-bend' => 7946,'near-the-foothills' => 7961,gate => 7973,dip => 8010,north => 7998,'on-the-right' => 7989,northwest => 8003,'in-the-valley' => 7959,'near-the-shore' => 7964,'moved-to-side-of-road' => 7949,'nearby-basin' => 8008,south => 7999,shoulder => 8027,'entering-or-leaving-tunnels' => 7939,'area-of' => 8017,'side-road' => 8030,'roadside-park' => 8033,'upper-level' => 7970,to => 8014,dock => 7978,'near-the-lake' => 7963,under => 8018,'cross-traffic' => 7993,'in-parts' => 7956,'on-curve' => 8026,through => 8016,'on-minor-roads' => 7943,'in-some-places' => 7957,'lower-level' => 7969,'in-shaded-areas' => 7952,concourse => 7972,'over-the-crest-of-a-hill' => 7965,'in-the-median' => 7948,'in-the-ditch' => 7958,'cross-road' => 8029,'on-the-roadway' => 7951,'at-weigh-station' => 7984,'baggage-claim' => 7974,east => 8000,'entering-at' => 8022,'in-the-downtown-area' => 7954,'in-the-opposing-lanes' => 7944,'near-beach-access-point' => 7968,station => 7976,'entire-intersection' => 7947,'park-and-ride-lot' => 8012,over => 8019,southeast => 8004,'southbound-traffic' => 7996,airport => 7971,'rest-area' => 7986,'at-service-area' => 7983,southwest => 8005,'adjacent-to-roadway' => 7945,'eastbound-traffic' => 7995,'at-rest-area' => 7982,'across-tracks' => 8024,intersection => 8032,'ev-charging-point' => 7980,'reservation-center' => 8007,'on-tracks' => 8009,'in-road-construction-area' => 7941,west => 8001,'in-street' => 8025,'in-the-inner-city-area' => 7955,toilets => 7988,'service-stations' => 7987,'bus-stop' => 8031,'in-tunnels' => 7938,from => 8020,'in-low-lying-areas' => 7953,'westbound-traffic' => 7997,by => 8015,'mountain-pass' => 8006,'near-the-beach' => 7967,'on-hill-top' => 7960,crossover => 8028,'around-a-curve' => 7942,approaching => 8021,'moved-to-shoulder' => 7950,northeast => 8002,'in-the-center' => 7991,'northbound-traffic' => 7994,'exiting-at' => 8023,'traffic-circle' => 8011,'on-bridges' => 7937,'at-high-altitudes' => 7962,'customs-point' => 7975,'on-the-left' => 7990,'on-ramps' => 7940}},'OPTIONAL'},{<<100,97,116,101,84,105,109,101>>,{typeinfo,{'Common','DDateTime'}},mandatory},{<<118,101,114,116,69,118,101,110,116>>,{{bit_string_nnl,[{notEquipped,0},{leftFront,1},{leftRear,2},{rightFront,3},{rightRear,4}]},5},'OPTIONAL'}]};
...
typeinfo('SpecialVehicleExtensions') ->
  {sequence,'SpecialVehicleExtensions',3,[{<<118,101,104,105,99,108,101,65,108,101,114,116,115>>,{typeinfo,{'Common','EmergencyDetails'}},'OPTIONAL'},{<<100,101,115,99,114,105,112,116,105,111,110>>,{typeinfo,{'BasicSafetyMessage','EventDescription'}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101>>,{typeinfo,{'BasicSafetyMessage','TrailerData'}},'OPTIONAL'}]};
...
typeinfo('SupplementalVehicleExtensions') ->
  {sequence,'SupplementalVehicleExtensions',13,[{<<99,108,97,115,115,105,102,105,99,97,116,105,111,110>>,{'INTEGER',{0,255}},'OPTIONAL'},{<<99,108,97,115,115,68,101,116,97,105,108,115>>,{typeinfo,{'Common','VehicleClassification'}},'OPTIONAL'},{<<118,101,104,105,99,108,101,68,97,116,97>>,{typeinfo,{'BasicSafetyMessage','VehicleData'}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101,49>>,{typeinfo,{'BasicSafetyMessage','WeatherReport'}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101,50>>,{typeinfo,{'BasicSafetyMessage','WeatherProbe'}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101,51>>,{typeinfo,{'BasicSafetyMessage','ObstacleDetection'}},'OPTIONAL'},{<<115,116,97,116,117,115>>,{typeinfo,{'BasicSafetyMessage','DisabledVehicle'}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101,52>>,{typeinfo,{'BasicSafetyMessage','SpeedProfile'}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101,53>>,{typeinfo,{'BasicSafetyMessage','RTCMPackage'}},'OPTIONAL'},{<<114,101,103,105,111,110,97,108>>,{sof,{sequence,'SupplementalVehicleExtensions_regional_SEQOF',2,[{<<114,101,103,105,111,110,73,100>>,{'INTEGER',{0,255}},mandatory},{<<114,101,103,69,120,116,86,97,108,117,101>>,{'ObjClassFieldType',{regionId,1},{componentrelation,{objectset,134,{'Externaltypereference',undefined,'BasicSafetyMessage',internal_object_set_argument_4}},[{outermost,[{'Externalvaluereference',134,'Common',regionId}]}]}},mandatory}]}},'OPTIONAL'},{<<102,104,119,97,86,101,104,105,99,108,101,67,108,97,115,115>>,{'ENUMERATED_EXT',#{motorcycles => 1,buses => 4,passengerCars => 2,other2axle4tireSingleUnitVehs => 3,twoAxle6TireSingleUnitTrucks => 5,threeAxleSingleUnitTrucks => 6,fourOrMoreAxleSingleUnitTrucks => 7,fourOrFewerAxleSingleTrailerTrucks => 8,fiveAxleSingleTrailerTrucks => 9,sixOrMoreAxleSingleTrailerTrucks => 10,fiveOrFewerAxleMultiTrailerTrucks => 11,sixAxleMultiTrailerTrucks => 12,sevenOrMoreAxleMultiTrailerTrucks => 13}},mandatory},{<<116,114,97,105,108,101,114,115>>,{typeinfo,{'Common','TrailersJ2945Slash1B'}},'OPTIONAL'},{<<115,99,104,111,111,108,66,117,115>>,{typeinfo,{'Common','SchoolBusJ2945Slash1C'}},'OPTIONAL'}]};
typeinfo('TrailerData') ->
  {sequence,'TrailerData',3,[{<<100,111,78,111,116,85,115,101>>,{'INTEGER',{0,31}},mandatory},{<<99,111,110,110,101,99,116,105,111,110>>,{typeinfo,{'BasicSafetyMessage','PivotPointDescription'}},mandatory},{<<117,110,105,116,115>>,{typeinfo,{'BasicSafetyMessage','TrailerUnitDescriptionList'}},mandatory}]};
...
typeinfo('VehicleData') ->
  {sequence,'VehicleData',8,[{<<104,101,105,103,104,116>>,{'INTEGER',{0,127}},'OPTIONAL'},{<<98,117,109,112,101,114,115>>,{typeinfo,{'Common','BumperHeights'}},'OPTIONAL'},{<<109,97,115,115>>,{'INTEGER',{0,255}},'OPTIONAL'},{<<100,111,78,111,116,85,115,101>>,{'INTEGER',{0,64255}},'OPTIONAL'},{<<116,114,97,105,108,101,114,80,114,101,115,101,110,116>>,'BOOLEAN','OPTIONAL'},{<<112,105,118,111,116,80,111,105,110,116>>,{typeinfo,{'BasicSafetyMessage','PivotPointDescription'}},'OPTIONAL'},{<<97,120,108,101,115>>,{typeinfo,{'Common','Axles'}},'OPTIONAL'},{<<108,101,97,110,65,110,103,108,101>>,{'INTEGER',{-90,90}},'OPTIONAL'}]};
