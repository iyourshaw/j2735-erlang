...
-define('roadSafetyMessage', 33).
-define('roadWeatherMessage', 34).
-define('probeDataConfigMessage', 35).
-define('probeDataReportMessage', 36).
-define('tollAdvertisementMessage', 37).
-define('tollUsageMessage', 38).
-define('tollUsageAckMessage', 39).
-define('cooperativeControlMessage', 40).
-define('sensorDataSharingMessage', 41).
-define('maneuverSharingAndCoordinatingMessage', 42).
-define('roadGeometryAndAttributes', 43).
-define('personalSafetyMessage2', 44).
-define('trafficSignalPhaseAndTiming', 45).
-define('signalControlAndPrioritizationRequest', 46).
-define('signalControlAndPrioritizationStatus', 47).
-define('roadUserChargingConfigMessage', 48).
-define('roadUserChargingReportMessage', 49).
-define('trafficLightStatusMessage', 50).
